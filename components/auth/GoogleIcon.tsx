/**
 * Multi-color "G" mark from Google's brand assets, inlined as SVG so we
 * don't ship the AntD `<GoogleOutlined>` line glyph (which doesn't match
 * the brand and causes "this isn't really Google" hesitation in users).
 *
